...
static struct clk_regmap *gcc_mdm9625_clocks[] = {
	[GPLL0] = &gpll0.clkr,
...
static const struct qcom_reset_map gcc_mdm9625_resets[] = {
	[GCC_USB_HS_HSIC_BCR] = { 0x0400 },
	[GCC_USB_HS_BCR] = { 0x0480 },
};

static struct gdsc *gcc_mdm9625_gdscs[] = {
	[USB_HS_HSIC_GDSC] = &usb_hs_hsic_gdsc,
};

static const struct regmap_config gcc_mdm9625_regmap_config = {
	.reg_bits     = 32,
	.reg_stride   = 4,
	.val_bits     = 32,
	.max_register = 0x4000,
...
static const struct qcom_cc_desc gcc_mdm9625_desc = {
	.config = &gcc_mdm9625_regmap_config,
	.clks = gcc_mdm9625_clocks,
	.num_clks = ARRAY_SIZE(gcc_mdm9625_clocks),
	.resets = gcc_mdm9625_resets,
	.num_resets = ARRAY_SIZE(gcc_mdm9625_resets),
	.gdscs = gcc_mdm9625_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_mdm9625_gdscs),
};
...
static const struct of_device_id gcc_msm8974_match_table[] = {
	{ .compatible = "qcom,gcc-mdm9625", .data = &gcc_mdm9625_desc },
...
static int gcc_msm8974_probe(struct platform_device *pdev)
{
	...
	if (!of_device_is_compatible(dev->of_node, "qcom,gcc-msm8974")) {
		if (data == &gcc_msm8226_desc || data == &gcc_mdm9625_desc)
