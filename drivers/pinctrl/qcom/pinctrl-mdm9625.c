...
static const struct pinctrl_pin_desc mdm9625_pins[] = {
...
static const char * const gpio_groups[] = {
	...
	"gpio71", "gpio72", "gpio73", "gpio74", "gpio75"
};
...
static const struct pinfunction mdm9625_functions[] = {
...
static const struct msm_pingroup mdm9625_groups[] = {
	PINGROUP(0,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(1,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(2,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(3,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(4,   blsp_spi2, NA, blsp_uim2, NA, NA, NA, NA),
	PINGROUP(5,   blsp_spi2, NA, blsp_uim2, NA, NA, NA, NA),
	PINGROUP(6,   blsp_spi2, NA, blsp_i2c2, NA, NA, NA, NA),
	PINGROUP(7,   blsp_spi2, NA, blsp_i2c2, NA, NA, NA, NA),
...
#define NUM_GPIO_PINGROUPS 76

static const struct msm_gpio_wakeirq_map mdm9625_mpm_map[] = {
...
static const struct msm_pinctrl_soc_data mdm9625_pinctrl = {
	.pins = mdm9625_pins,
	.npins = ARRAY_SIZE(mdm9625_pins),
	.functions = mdm9625_functions,
	.nfunctions = ARRAY_SIZE(mdm9625_functions),
	.groups = mdm9625_groups,
	.ngroups = ARRAY_SIZE(mdm9625_groups),
	.ngpios = NUM_GPIO_PINGROUPS,
	//.wakeirq_map = mdm9625_mpm_map,
	//.nwakeirq_map = ARRAY_SIZE(mdm9625_mpm_map),
};

static int mdm9625_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &mdm9625_pinctrl);
}

static const struct of_device_id mdm9625_pinctrl_of_match[] = {
	{ .compatible = "qcom,mdm9625-pinctrl", },
	{ },
};

static struct platform_driver mdm9625_pinctrl_driver = {
	.driver = {
		.name = "mdm9625-pinctrl",
		.of_match_table = mdm9625_pinctrl_of_match,
	},
	.probe = mdm9625_pinctrl_probe,
};

static int __init mdm9625_pinctrl_init(void)
{
	return platform_driver_register(&mdm9625_pinctrl_driver);
}
arch_initcall(mdm9625_pinctrl_init);

static void __exit mdm9625_pinctrl_exit(void)
{
	platform_driver_unregister(&mdm9625_pinctrl_driver);
}
module_exit(mdm9625_pinctrl_exit);

MODULE_AUTHOR("Bartosz Dudziak <bartosz.dudziak@snejp.pl>");
MODULE_DESCRIPTION("Qualcomm MDM9625 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, mdm9625_pinctrl_of_match);
